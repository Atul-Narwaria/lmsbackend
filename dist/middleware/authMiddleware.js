...
exports.isSalesTeam = exports.isAdmin = exports.validateToken = void 0;
...
const isSalesTeam = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.userid;
    console.log(req.userid);
    if (!id) {
        return res.status(401).json({ message: 'Invalid token' });
    }
    const check = yield (0, salesTeam_1.CheckSalesTeamExistance)(id);
    console.log(check);
    if (check == 0) {
        return res.status(401).json({ message: 'SalesTeam role required' });
    }
    next();
});
exports.isSalesTeam = isSalesTeam;
