...
import { SalesTeamLoginSchema, SalesTeamRegistrationSchema } from '../../middleware/requestValidation';
import { RegisterSalesTeam, loginSalesTeam } from '../../controller/sales_team/salesteam.controller';
